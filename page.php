	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
		...
		<article>
			...
			<div class="photo_slide_container  photo_slide_size_medium">
					...
					<?php } ?>
					<div class="parallax photo_slide " style="background-image: url(<?php if(!empty($background_image['url'])){echo $background_image['sizes']['large'];} else {echo home_url() .  '/wp-content/uploads/2017/06/drybulk1.jpg';} ?>);"></div>
