<div class="container">
    ...
    <div class="locations_map_container">
        ...
        <div class="location_box_greece_1_ location_box">
            <h3>Greece</h3>
            <p>225-227 Kifissias Avenue <br />
        ...
        <div class="location_box_china location_box">
            <h3>China</h3>
            <p>Beijing<br />
        ...
        <div class="location_box_switzerland location_box location_box_large">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h4>Zug</h4>
                    <p>Industriestrasse 24, <br />
                        6300 Zug <br />
                        +41 58 411 31 57<br />
                        <a target="_blank" href="https://www.google.com/maps/place/Industriestrasse+24,+6300+Zug,+Switzerland/@47.1750911,8.5187759,18.2z">Google Maps</a>
                </div>
            </div>
        ...
        <div class="location_box_singapore_1_ location_box">
            <h3>Singapore</h3>
